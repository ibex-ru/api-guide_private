...
point | Широта и долгота точки, разделенные запятой. Относительно этой точи будут выданы результаты поиска. _Опциональный параметр_, по умолчанию - центр Москвы.
